import 'package:flutter/material.dart'; // Import the plant details screen
...
class PlantListScreen extends StatelessWidget {
  ...
  PlantListScreen({required this.categories});
      ...
      body: Padding(
        ...
        child: GridView.builder(
          ...
          itemBuilder: (context, index) {
            return buildPlantCategoryCard(context, categories[index]);
          },
        ),
      ),
    );
